...
<html class="no-js" lang="en">
    <head>
        <title>SportsSync | My Bookings </title>
                        ...
                        <div class="col-md-8 col-sm-7">
                            <div class="single-blog-body">
                                <div class="Leave-your-thought mt50">
                                            ...
                                            <div class="input-box leave-ib">
                                                <div class="table-responsive">
                                                    <table border="2" class="table">
                                                        ...
                                                        <?php
                                                        // Fetching Event Booking Details
                                                        $uid = $_SESSION['usrid'];
                                                        $sql = "SELECT tblbookings.id as bid, tblbookings.BookingId, tblbookings.BookingDate, tblbookings.BookingStatus, tblevents.EventName, tblevents.id as evtid 
                                                                FROM tblbookings 
                                    ...
                                    <!-- Add Training Bookings Section -->
                                    <div class="row" style="margin-top:30px;">
                                        <div class="col-md-12 col-sm-6 col-xs-12 lyt-left">
                                            <h3 class="aside-title uppercase">My Training Bookings</h3>
                                            <div class="input-box leave-ib">
                                                <div class="table-responsive">
                                                    <table border="2" class="table">
                                                        <tr>
                                                        ...
                                                        <?php
                                                        // Fetching Training Booking Details
                                                        $sql2 = "SELECT tbltrainingbookings.id as tid, tbltrainingbookings.BookingId, tbltrainingbookings.BookingDate, tbltrainingbookings.BookingStatus, tbltraining.TrainingName, tbltraining.id as trainingid 
                                                                 FROM tbltrainingbookings 
                                                                 LEFT JOIN tbltraining ON tbltraining.id = tbltrainingbookings.TrainingId 
                                                                 WHERE tbltrainingbookings.UserId = :uid";
                                                        ...
                                                        if($query2->rowCount() > 0)
                                                        {
                                                            ...
                                                            { ?>
                                                        <tr>
                                                            <td><?php echo htmlentities($cnt2);?></td>   
                                                            <td><?php echo htmlentities($row2->BookingId);?></td>  
                                                            <td>
  <a href="training-details.php?trnid=<?php echo htmlentities($row2->trainingid); ?>">
    <?php echo htmlentities($row2->TrainingName); ?>
  </a>
</td>

                                                            <td><?php echo htmlentities($row2->BookingDate);?></td>  
                                                            <td>
                                                                <?php 
                                                                $tstatus = $row2->BookingStatus;
                                                                if($tstatus==""){
                                                                    echo htmlentities("Not confirmed Yet");
                                                                } else {
                                                                    echo htmlentities($tstatus);
                                                                }
                                                                ?>
                                                            </td>  
                                                            <td>
                                                                <a href="training-booking-detail.php?bkid=<?php echo htmlentities($row2->tid);?>">
                                                                    <i class="fa fa-file-text"></i>
                                                                </a>
                                                            </td>   
                                                        </tr>
