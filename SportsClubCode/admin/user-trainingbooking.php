...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <?php // Display the user's bookings header ?>
            <div class="col-lg-12">
                <h1 class="page-header"><?php echo htmlentities($uname); ?>'s Training Bookings</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php
// Retrieve confirmed training bookings for the user
$sql = "SELECT 
            tb.id as bid,
            tb.BookingId,
            tt.trainingName,
        ...
        LEFT JOIN tblusers tu ON tu.id = tb.UserId
...
?>
                                            ...
                                            <td>
                                                <a href="trainingbookingdetails.php?bkid=<?php echo htmlentities($row->bid); ?>">
