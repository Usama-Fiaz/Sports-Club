...
if(strlen($_SESSION['adminsession'])==0) {
    ...
    // Replace 'Userid' and 'FullName' if your columns differ
    $sql = "SELECT 
              orders.id,
              orders.orderNumber,
              tblusers.FullName,
            ...
            WHERE orders.orderStatus = 'Packed'";
...
<html lang="en">
<head>
    <title>SportsSync | Packed Orders</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <h1 class="page-header">Packed Orders</h1>
            <div class="panel panel-default">
                <div class="panel-heading"><i class=""></i> Packed Order Details</div>
