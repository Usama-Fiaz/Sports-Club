...
<head>
    <title>SportsSync | Manage Subcategories</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Manage Subcategories</h1>
            </div>
        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-subcategory.php?subcatid=<?php echo htmlentities($row->id);?>">
                                                <button type="button" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></button>
                                            </a>
                                            <a href="manage-sub-category.php?del=<?php echo htmlentities($row->id);?>" onclick="return confirm('Are you sure you want to delete this subcategory?');">
